...
if ($q->have_posts() ) : ?>
<?php do_action( 'bpsp_before_moderation_posts_content' ) ?>
...
<?php do_action( 'bpsp_before_moderation_posts_list' ) ?>
<?php
global $post;
bpsp_loop_start();
?><form><?php
...
<div class="post" id="post-<?php the_ID(); ?>">
	<div class="post-content">
		...
		<p class="postmetadata"><span class="tags"><?php the_tags( sanitize_text_field(esc_attr__( 'Tags: ', 'bp-site-post' )), ', ', '<br />'); ?></span> <span class="comments"><?php comments_popup_link( sanitize_text_field(esc_attr__( 'No Comments &#187;', 'bp-site-post' )), sanitize_text_field(esc_attr__( '1 Comment &#187;', 'bp-site-post' )), esc_attr__( '% Comments &#187;', 'bp-site-post' ) ); ?></span></p>
		...
		<em class="post-date"><?php echo sanitize_text_field(esc_attr__( 'Post Date: ', 'bp-site-post' )); echo esc_attr(sanitize_text_field(get_the_time(get_option( 'date_format' ))));?></em>
...
<?php 
	do_action( 'bpsp_after_moderation_posts_content' ) ;
	bpsp_loop_end();
?>
